...
```sh
curl -fsSL shalom2552.github.io/agent-skills/install | bash
```

Or clone and run `./install`. See `./install --help` for options.
...
| `dotconf` | Answer, change, and remember dotfile and app configs. |
